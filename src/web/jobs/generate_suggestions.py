...
from utils.db_utils import get_all_users, get_latest_city_events_list, get_latest_suggestion_time, get_latest_user_tastes, insert_user_suggestions
from events.event_selector import get_recommended_events
...
def run_suggestions_job(app: Flask) -> None:
    """For each user, if due, generate and store event suggestions."""
    ...
    for u in users:
        ...
        def _build_payload():
            events = get_latest_city_events_list(location_value = u.get("location_value"))
